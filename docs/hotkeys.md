...
Escape, Space and Tab while a capture selection is up. Screenshot panels deliberately never take
keyboard focus, so menu-bar menus retain their focus across modifier-key changes. A transient key is deliberately *not* a
